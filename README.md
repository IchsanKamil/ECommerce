...
|  7  | /customers/register                | POST      |
|  8  | /customers/login                   | POST      |
|  9  | /customers/:CustomerId             | POST      |
| 10  | /customers/:CustomerId             | GET       |
| 11  | /customers/:CustomerId/:ProductId  | PUT       |
| 12  | /customers/:CustomerId/:ProductId  | DELETE    |
...
```json
{
    "message": "Email can't be empty, Email already exist, Password must be between 4 & 20 characters"
}
```
---
